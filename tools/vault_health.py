...
Per-loop heartbeat tracking (flag a loop overdue by >2x its cadence) is
deferred to a later session — it needs the loops to adopt a commit-subject
prefix convention first. Until then this dashboard shows overall liveness only,
and says so.
