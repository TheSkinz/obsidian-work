...
- **Route geometry.** The survey as supplied traces an L-shape: A→I heads roughly S-SW, I→AF heads SW, and after Bend 4 the return leg heads NW, ending about 3,300 ft from the launch point. The brief says launch and receive were one site and the line doubles back. The page plots the coordinates as given and says the surveyed endpoints do not coincide. Not adjusted.
