...
**A. Ask Jesse now and record the answer in `7-1-F-1.md`'s Field Notes or ft/hr note, independent of the parked schema decision.** Cheap to capture while the job is still recent memory; avoids re-deriving or re-asking when the schema decision eventually reopens. Narrow ask: for CAD25004's per-coilset splits (Trimax 5: 63 hrs / Trimax 6 coils 5-7: 48 hrs / Trimax 6 coils 1&8: 53 hrs), do the "Pig" hours in each sub-total include fill/flush/dewater time, or only pig-travel time?
