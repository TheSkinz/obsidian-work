...
Jesse opened a session on 2026-08-20 for the CAD26001 Syncrude mobilization (mob 08-25, rig-in 08-26) [the prefix was changed to `CND` on 2026-08-21 and **changed back to `CAD` on 2026-09-02**, which is correct and always was; the 2026-08-21 ruling was a company reversal since reversed, and this note has been normalised to `CAD` throughout] and, in the course of it, corrected two of my readings and then supplied drawings he had not seen before. The drawings overturned the heater card's geometry. The chain matters more than the endpoint, so it is recorded in order.
