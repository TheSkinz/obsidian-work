...
|---|---|---|---|---|---|
| CAD26001 | Syncrude Mildred Lake, Fort McMurray AB | **TBC — [[7-1-F-1]] or its mirror-image sister `7-2 F-1`.** The mob email names no heater and Dacorey did not know (2026-08-20). Naming itself is settled — it is `7-2 F-1`, not "7-1 F-2" — so the open question is only *which of the two*, or both. Ask Syncrude or check the PO/work order, which will carry the `7-nF-001` CMS form. | PO 1300060001 | Mob 2026-08-25 (flights to Edmonton), rig-in 2026-08-26 | Third campaign on 7-1F-1 if that is the unit (after CND24002 April 2024, CND25004 Sept 2025). Trimax 5 / Support 5 / Trimax 6 / Support 6 — same pair as CND25004, where **Trimax 6 mobbed from Edmonton**, so confirm whether it is still staged in Canada. **No filter press assigned** (consistent: CND24002 drained to oily-water sewer, CND25004 unrecorded — but nothing covers filtration if Syncrude elects it). Crew of 10: day = Dacory Slater (PM), Marshall Douglas, Travis Trenholm, Peter Campbell, Jason Harman; night = Sam (supervisor), **Jesse (operator)**, Danilo, Rodney Boudoin, JC. 24-hr coverage from 08-26 **TBD** pending Syncrude — plant reported running ahead of schedule, which would reverse this heater's history (36 hrs standby in 2024, ~192 hrs in 2025, both waiting on the plant to de-inventory, drain and blind). Rentals: 4 vehicles — Edmonton (Kelly, name on booking unresolved in the email), Marshall from Calgary Sunday, Travis from Red Deer. Work visas required — paperwork carried, not checked; declare to customs. Camp assignments pending. FR coveralls with reflective striping mandatory. Site driving authorization via Marshall. | Mob 2026-08-04, rig-in 2026-08-05 07:00 | PO TBD. Mechanical decoke + smart-pig support, double mode, 1 Trimax with filtration; 28 quoted hrs, 2 days / 3 shifts. Jesse PM of record. Trimax 5 / Support 5 / Press 2 staged in plant laydown; Glider to be picked up from Deer Park pre-mob. Crew (5 against a 6-slot quoted plan — nights runs 1 operator): Jesse (day sup), Sam (night sup), Andre, Brandon, Blake B. → [[USA26040-job-sheet]]. |
