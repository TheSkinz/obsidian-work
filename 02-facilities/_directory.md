...
| Westlake South | Westlake, LA | **New 2026-07-27.** Facility overview `_facility.md` + heater card [[TE-II]] (EDC pyrolysis furnace, plant equip. 71-1686, Tri-Ethane unit; 1989 Selas OEM data sheet, coil confirmed as-built by Jesse). New to the vault, **not** new to USADeBusk — prior Westlake work and its governing contract/rates live outside the vault. Site formerly PPG Industries; do not create a second record under PPG or Lake Charles. Quote # pending. |
