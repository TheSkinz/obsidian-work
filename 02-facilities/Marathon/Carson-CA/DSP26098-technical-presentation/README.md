...
- `LAR_Technical_Proposal_Presentation.pptx`: the deck, 27 slides, with speaker notes on every slide (about 39 minutes). There is no appendix: the pump curve (slide 13) and the MPC contact table (slide 24) sit in the body next to the slides that discuss them, and Q&A is last. Revision 7 (2026-09-23) added Marshall Douglas's recommendations: an engineered-pig slide, the Marathon Detroit 70H1 case study, the 200+ years experience figure, standardized-fleet wording, the named team org chart (210 years combined) and an optional closed-loop filtration slide.
