...
- `LAR_Technical_Proposal_Presentation.pptx`: the deck, 27 slides, with speaker notes on every slide (about 38 minutes). Slides 26 and 27 are the appendix: MPC references and the pump curves. Revision 7 (2026-09-23) added Marshall Douglas's recommendations: an engineered-pig slide, the Marathon Detroit 70H1 case study, the 200+ years experience figure, standardized-fleet wording, the named team org chart (210 years combined) and an optional closed-loop filtration slide.
