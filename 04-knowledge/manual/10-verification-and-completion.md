...
Do not write this as "Clean ID". **Clean ID is the field-measured bore of the tube** — a sizing input, and on a coil where the drawing understates the bore it is the number pig sizing keys off (CHS HF-0012, six shift tickets at 3.7" against a 3.232" design ID). The final pig size is what the progression achieved against it. Conflating the two was corrected on 2026-09-03; see [[17-glossary]].
