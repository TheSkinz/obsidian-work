...
**Generated:** 2026-08-01 — all Task Durations actuals across heater cards, against the estimating benchmarks. Reference only: benchmark or rate changes are Lane 4 (Jesse decides; `usadebusk-estimating` is then edited in the config repo).
